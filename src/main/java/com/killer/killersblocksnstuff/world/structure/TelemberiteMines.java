...
public class TelemberiteMines extends StructureFeature<JigsawConfiguration> {
    ...
    public TelemberiteMines() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, TelemberiteMines::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        return !context.chunkGenerator().hasFeatureChunkInRange(BuiltinStructureSets.END_CITIES, context.seed(), chunkpos.x, chunkpos.z, 10);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!TelemberiteMines.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            KBNS.LOGGER.debug("Mine At {}", blockpos);
        }
