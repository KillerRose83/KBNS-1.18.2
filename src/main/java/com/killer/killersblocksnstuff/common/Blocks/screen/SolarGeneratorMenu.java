...
import com.killer.killersblocksnstuff.common.Blocks.screen.slot.ResultSlot;
...
public class SolarGeneratorMenu extends AbstractContainerMenu {
    private final SolarGeneratorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public SolarGeneratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public SolarGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(KbnsMenuTypes.SolarGeneratorMenu.get(), pContainerId);
        checkContainerSize(inv, 1);
        blockEntity = ((SolarGeneratorBlockEntity) entity);
    ...
    public int getScaledEnergy() {
        ...
        int maxEnergy = this.data.get(1);  // Max Progress
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockInit.SOLAR_GENERATOR.get());
    }
