...
public class BlockInit {
    ...
    public static final RegistryObject<Block> VIBRANIUM_ORE = BLOCKS.register("vibranium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.
            ANCIENT_DEBRIS).strength(10.0F, 100.0F).sound(SoundType.ANCIENT_DEBRIS).requiresCorrectToolForDrops()));
